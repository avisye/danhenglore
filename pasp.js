...
const eng = ['GU MVD <br> OF RUSSIA IN THE MOSCOW CITY', 'GAFUROVA', 'AZIZAKHON', 'BAKHTIEROVNA', 'F', 'KAYROKKUM', 'SOGDIYSKAYA OBL'];

const rus = ['ГУ МВД ПО Г. МОСКВЕ', 'ГАФУРОВА', 'АЗИЗАХОН', 'БАХТИЁРОВНА', 'ЖЕН.', 'Г. КАЙРОККУМ', 'СОГДИЙСКАЯ ОБЛ.']
